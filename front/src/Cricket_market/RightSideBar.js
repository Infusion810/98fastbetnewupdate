...
const BetInputSection = styled.div`
  display: flex;
  margin-bottom: 15px;
  gap: 10px;
`;
...
const StakeButtonsGrid = styled.div`
  display: grid;
      ...
      {betPopup && (
        <PopupOverlay>
          <PopupContainer>
            ...
            <BetContent>
              <TeamSection>
                <TeamName>{selectedBet?.label || "Grenadine Divers"}</TeamName>
                <ProfitText>{displayProfit()}</ProfitText>
              </TeamSection>
              ...
              <BetInputSection>
                <AmountInput
                  ...
                  placeholder="Amount"
                />
                <OddsDisplay>{selectedBet.odds || "2.2"}</OddsDisplay>
              </BetInputSection>
              ...
              <StakeButtonsGrid>
                ...
                <StakeButton onClick={() => handleStakeButtonClick(50000)}>+50k</StakeButton>
                <StakeButton onClick={() => handleStakeButtonClick(75000)}>+75k</StakeButton>
                <StakeButton onClick={() => handleStakeButtonClick(90000)}>+90k</StakeButton>
                <StakeButton onClick={() => handleStakeButtonClick(95000)}>+95k</StakeButton>
              </StakeButtonsGrid>

              <ActionButtonsRow>
                <ActionButton className="edit">Edit</ActionButton>
                <ActionButton className="reset" onClick={resetBet}>
                  Reset {timer ? (`${timer}`) : ""}
                </ActionButton>
                <ActionButton className="place" onClick={handleSubmitWithBalanceCheck}>
                  Place Bet
                </ActionButton>
              </ActionButtonsRow>
            </BetContent>
