...
const T20Content = () => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    console.log("final exposure ", exposure);
  }, [
    selectedBet,
    stakeValue,
    balance,
    ...
    <>
      ...
      <div className="T20_container">
        ...
        <div className="left_side">
          ...
          <div className="balance_exposure">
            <p>Balance: {balance}</p>
...
//   const [prevOverMarketExposure, setPrevOverMarketExposure] = useState(0);
//   const [newMarketOddsExposure, setNewMarketOddsExposure] = useState(0);
//   const [isBetProcessing, setIsBetProcessing] = useState(false); // Added to prevent duplicate bet processing
//   const [shouldRefreshWallet, setShouldRefreshWallet] = useState(false); // Added to control wallet refresh
...
//   // Control wallet refresh separately
//   useEffect(() => {
//     if (shouldRefreshWallet) {
//       fetchWalletData();
//       setShouldRefreshWallet(false);
//     }
//   }, [shouldRefreshWallet]);
...
//       // Set current stake for the bet placement
//       setCurrentStake(stakeValue);
      
//       // This is the key change - set balanceChange to true only here, after a user
//       // explicit action (clicking submit)
//       setBalanceChange(true);
...
//   // MODIFIED: This useEffect was causing the auto-trigger loop
//   // Remove the automatic balanceChange trigger
//   useEffect(() => {
...
//   // MODIFIED: Added bet processing flag to prevent multiple executions
//   useEffect(() => {
//     if (balanceChange && !isBetProcessing) {
//       if (selectedBetType === "Lgaai" || selectedBetType === "khaai") {
//         setIsBetProcessing(true); // Prevent duplicate processing
//         setSubmitClick((prev) => (prev + 1));
//         setBalanceChange(false);
...
//             const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/laggai_khai_bets`, newBet);
//             if (response.status == 201) {
//               // Use the separate wallet refresh mechanism instead
//               setShouldRefreshWallet(true);
//               setSuccessMessage("Bet placed successfully.");
//               setSuccessPopup(true);
//             } else {
//               toast.error(response.data.message || "Failed to place bet.");
...
//         placeBet();
//       } else {
//         // If bet type isn't valid, just reset states
//         setBalanceChange(false);
//         setIsBetProcessing(false);
//       }
//     }
...
//     console.log("balance handleSubmit", balance);
//     console.log("exposure handleSubmit", exposure);
//     // console.log("submitClick handleSubmit", submitClick);
//   }, [
//     selectedBet,
//     stakeValue,
//     balance,
