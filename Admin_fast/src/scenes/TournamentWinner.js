                      ...
                      <TableCell>
                        {isMatchOdds ? (
                          <div style={{ 
                            padding: '8px', 
                            borderRadius: '4px',
                            backgroundColor: row.result === 'Winner' ? '#4caf50' : 
                                          row.result === 'loss' ? '#f44336' :
                                          row.result === 'Draw' ? '#ff9800' : '#e0e0e0',
                            color: row.result === 'Pending' ? '#666' : 'white',
                            fontWeight: 'bold',
                            textAlign: 'center'
                          }}>
                            {row.result || 'Pending'}
                          ...
                          <div style={{ 
                            padding: '8px', 
                            borderRadius: '4px',
                            backgroundColor: row.winningRuns ? '#4caf50' : '#e0e0e0',
                            color: row.winningRuns ? 'white' : '#666',
                            fontWeight: 'bold',
                            textAlign: 'center'
                          }}>
                            {row.winningRuns ? `${row.winningRuns} Runs` : 'Pending'}
                          </div>
                        )}
                      </TableCell>
                    </tr>
